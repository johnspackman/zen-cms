...
/**
 * Represents a piece of work to be executed by an instance of zx.server.work.Worker

  @typedef WorkJson Object describing the work
...
qx.Interface.define("zx.server.work.IWork", {
  members: {
     ...
     * Executes the work
     *
     * @param {zx.server.work.Worker} worker the Worker that is executing this Work
